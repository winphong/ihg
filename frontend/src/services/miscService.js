...
function getInstagramPhotos() {
  ...
  const response = axios.get(
    "https://graph.instagram.com/me/media?fields=media_url,%20permalink&access_token=IGQVJVOE43ZAFJqcnFTUE1HRDd5WTFsWGNtOFNUZA1ZA4MHhVSlRxVFZAZAcUtwajlfQW5kalh2aGR6MS0yYnh4Tm9lUTZAWT1Vmd1ZAhZAkY5Nmd0SFZASVVBHek9JOFJadWRsWjNYNkpmbVFn"
  );
  http.setJwt(getJwt());
  return response;
}
